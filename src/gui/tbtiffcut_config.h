...
#ifndef GUI_TBTIFFCUT_CONFIG_H_
#define GUI_TBTIFFCUT_CONFIG_H_

#define TC_VERSION "0.1.0"
#define TC_LICENSE "Copyright (C) 2020  kogo (kogo@gmx.de)\n\
\n\
...
#define INIFILE "tbtiffcut_wx.ini"

#endif /* GUI_TBTIFFCUT_CONFIG_H_ */
